...
void update(float dt){
  ...
  if(shiftPressed){
  if (leftPressed) obstacleVel = new Vec2(-obstacleSpeed*2,0);
  if (rightPressed) obstacleVel = new Vec2(obstacleSpeed*2,0);
  if (upPressed) obstacleVel = new Vec2(0,-obstacleSpeed*2);
  if (downPressed) obstacleVel = new Vec2(0,obstacleSpeed*2);
  
    if (rightPressed && upPressed) obstacleVel = new Vec2((obstacleSpeed/sqrt(2))*2,(-obstacleSpeed/sqrt(2)*2));
  if (rightPressed && downPressed) obstacleVel = new Vec2((obstacleSpeed/sqrt(2))*2,(obstacleSpeed/sqrt(2)*2));
  if (leftPressed && upPressed) obstacleVel = new Vec2((-obstacleSpeed/sqrt(2)*2),(-obstacleSpeed/sqrt(2)*2));
  if (leftPressed && downPressed) obstacleVel = new Vec2((-obstacleSpeed/sqrt(2)*2),(obstacleSpeed/sqrt(2)*2));
  }
  else{
